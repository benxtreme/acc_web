                    ...
                    <ul class="m-additional-nav__pages-links" aria-labelledby="nav-pages">
                        ...
                        <li>
                            <h3 class="m-additional-nav__pages-title">
                                <a href="index.php" id="nav-group-about--2" class="title-serif--small">About</a>
                            </h3>
                            ...
                            <ul id="nav-group-list-about--2" class="m-additional-nav__submenu-links"
                                ...
                                <li>
                                    <a href="index.php#about-abmtc" class="label-sans">Overview</a>

                                </li>
                                <li>
                                    <a href="index.php#mission-vision-history" class="label-sans">Mission, Vision,
                                        &amp; History</a>

                                </li>
                                <li>
                                    <a href="index.php#founder-bdhm" class="label-sans">Bishop Dag Heward-Mills</a>

                                </li>
                                <li>
                                    <a href="index.php#campus" class="label-sans">Campus</a>
                        ...
                        <li>
                            ...
                            <ul id="nav-group-list-admissions--2" class="m-additional-nav__submenu-links"
                                ...
                                <li>
                                    <a href="admissions#requirements" class="label-sans">Requirements</a>

                                </li>
                                <li>
                                    <a href="admissions/#how-to-apply" class="label-sans">How to Apply</a>
                        ...
                        <li>
                            ...
                            <ul id="nav-group-list-academics--2" class="m-additional-nav__submenu-links"
                                ...
                                <li>
                                    <a href="academics.php#liberal-arts-sciences" class="label-sans"> Lectures</a>

                                </li>
                                <li>
                                    <a href="academics.php#faculty" class="label-sans">Pastoral Training</a>

                                </li>
                                <li>
                                    <a href="academics.php#research" class="label-sans">Programs</a>
                        ...
                        <li>
                            ...
                            <ul id="nav-group-list-life-at-harvard--2" class="m-additional-nav__submenu-links"
                                ...
                                <li>
                                    <a href="anagkazo-life.php#residential-life" class="label-sans">Residential
                                        Life</a>

                                </li>
                                <li>
                                    <a href="anagkazo-life.php#student-activities" class="label-sans">Student
                                        Activities</a>

                                </li>
                                <li>
                                    <a href="anagkazo-life.php#accomodation" class="label-sans">Accomodation</a>

                                </li>
                                <li>
                                    <a href="anagkazo-life.php#student-activies" class="label-sans">Student
                                        Stories</a>
                        ...
                        <li>
                            ...
                            <ul id="nav-group-list-life-at-harvard--2" class="m-additional-nav__submenu-links"
                                ...
                                <li>
                                    <a href="campus.php" class="label-sans">Overview</a>
                        ...
                        <li>
                            <h3 class="m-additional-nav__pages-title">
                                <a href="alumni.php" id="nav-group-life-at-harvard--2"
                                    class="title-serif--small">Alumni</a>
                            </h3>
                            <button class="m-additional-nav__submenu-toggle _accordion-toggle" data-targetid="next"
                                aria-controls="nav-group-list-life-at-harvard--2" aria-expanded="false"
                                data-closedelay="10">
                                <span>
                                    <span class="u-sr-only">Toggle Alumni Submenu</span>
                                    <span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            height="16" viewBox="0 0 16 16">
                                            <polygon
                                                points="121 113 128 113 128 115 121 115 121 122 119 122 119 115 112 115 112 113 119 113 119 106 121 106"
                            ...
                            <ul id="nav-group-list-life-at-harvard--2" class="m-additional-nav__submenu-links"
                                ...
                                <li>
                                    <a href="alumni.php" class="label-sans">Overview</a>

                                </li>
                                <li>
                                    <a href="alumni.php#stay-connected" class="label-sans">Residential
                                        Life</a>

                                </li>
                                <li>
                                    <a href="alumni.php#community" class="label-sans">Student
                                        Activities</a>

                                </li>
                                <li>
                                    <a href="alumni.php#giving" class="label-sans">Accomodation</a>
                            ...
                            <nav class="m-site-info__links-group" aria-labelledby="site-info-links-group-1-header">
                                ...
                                <ul class="m-site-info__links-list">
                                    ...
                                    <li><a href="#" class="external-link label-sans u-under-link"
                                            ...
                                            Portal</a></li>
                                    <li><a href="#" class="internal-link label-sans u-under-link">Admitted Students</a>
                                    </li>
                                </ul>
                            </nav>
                        ...
                        <div class="o-container-fluid">
                            <div class="m-site-info__colophon-row">
                                ...
                                <div class="m-site-info__copyright">
                                    Copyright © 2020 Anagkazo Bible and Ministry Training Center
                                </div>
        ...
        <div class="views-element-container" id="block-views-block-global-alerts-block-2">
            ...
            <div>
                <div id="college-alert-messages" class="m-college-alerts" role="alert" aria-live="polite">
                    ...
                    <div id="alert-303169" class="m-global-alert m-global-alert--open m-global-alert--red">
                        <div id="alert-303169-full-content" class="m-global-alert__full _u-orange" aria-hidden="false"
                            tabindex="-1">
                            <div class="m-global-alert__content">
                                <h2 class="m-global-alert__title"><span class="u-sr-only">Alert: </span>Apply Now
                                </h2>
                        ...
                        <div class="m-global-alert__teaser _u-orange">
                            <h2 class="m-global-alert__teaser-title">
                                <button id="alert-303169-teaser-button"
                                    class="js-alert-button m-global-alert__teaser-button" aria-expanded="false">
                                    <span class="u-sr-only">Open Alert: </span>Apply Now
